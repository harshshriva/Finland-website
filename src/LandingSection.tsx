    ...
    <div className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-4 mt-8 pt-12">
        <div className="text-center mt-10 pt-8">
          ...
          <h2 className="text-[#002F6C] font-black pt-4 text-5xl md:text-6xl lg:text-[8rem] leading-none tracking-tight mb-8 text-stroke-white drop-shadow-[0_2px_0_white]
            drop-shadow-[2px_0_0_white]
            drop-shadow-[-2px_0_0_white]
            drop-shadow-[0_-2px_0_white]">
            Simplified
          ...
          {/* Subtitle */}
          <p className="text-green-700 text-lg md:text-xl lg:text-2xl font-bold text-center max-w-4xl mx-auto leading-relaxed drop-shadow-[0_4px_8px_rgba(0,0,0,0.7)]">
